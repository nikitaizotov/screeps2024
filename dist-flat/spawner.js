...
exports.KernelSpawner = void 0;
const body_factory_1 = require("./body.factory");
/**
...
class KernelSpawner {
    maintainCrew(crew) {
        ...
        if (!spawn)
            return;
        const body = (0, body_factory_1.buildBody)(crew.unitBody, room.energyAvailable);
        if (body.length === 0)
            return;
...
exports.KernelSpawner = KernelSpawner;
